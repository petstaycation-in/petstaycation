...
export default function PetPolicyPage() {
  return <PolicyPage title="Pet Policy" summary="Pet-friendly does not mean every property has identical rules. The property-specific policy confirmed with your booking always takes priority.">
    ...
    <section><h2>Property rules</h2><p>Properties may set limits on pet numbers, types, sizes, furniture, pools, dining areas and unattended pets. For the stays currently listed by Petstaycation, pets stay complimentary with no additional pet accommodation charge.</p></section>
